...
CREATE TABLE t_p38880412_quest_dashboard_mana.quests (
  id SERIAL PRIMARY KEY,
  site_id INT REFERENCES t_p38880412_quest_dashboard_mana.sites(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
CREATE TABLE t_p38880412_quest_dashboard_mana.levels (
  id SERIAL PRIMARY KEY,
  quest_id INT REFERENCES t_p38880412_quest_dashboard_mana.quests(id) ON DELETE CASCADE,
...
CREATE TABLE t_p38880412_quest_dashboard_mana.member_quest_access (
  id SERIAL PRIMARY KEY,
  member_id INT REFERENCES t_p38880412_quest_dashboard_mana.members(id) ON DELETE CASCADE,
  quest_id INT REFERENCES t_p38880412_quest_dashboard_mana.quests(id) ON DELETE CASCADE,
...
CREATE TABLE t_p38880412_quest_dashboard_mana.progress (
  id SERIAL PRIMARY KEY,
  member_id INT REFERENCES t_p38880412_quest_dashboard_mana.members(id) ON DELETE CASCADE,
  level_id INT REFERENCES t_p38880412_quest_dashboard_mana.levels(id) ON DELETE CASCADE,
...
CREATE TABLE t_p38880412_quest_dashboard_mana.invite_links (
  ...
  quest_id INT REFERENCES t_p38880412_quest_dashboard_mana.quests(id) ON DELETE SET NULL,
  site_id INT REFERENCES t_p38880412_quest_dashboard_mana.sites(id) ON DELETE SET NULL,
